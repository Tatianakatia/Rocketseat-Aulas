  ...
  incomes() {
    ...
    Transaction.all.forEach(transaction => {
      ...
      if (transaction.amount > 0) {
        // sum each variable  and return a variable
...
const Form = {
  ...
  submit(event) {
    ...
    try {
      // check all information is filled
      Form.validateFields()
      // format all data to salve
      const transaction = Form.formatValues()
      // save
      Transaction.add(transaction)
      // delete all data of form
      Form.clearFields()
      // modal close
      Modal.close()
